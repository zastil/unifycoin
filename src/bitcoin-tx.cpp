...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s unifycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  unifycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded unifycoin transaction") + "\n" +
              "  unifycoin-tx [options] -create [commands]   " + _("Create hex-encoded unifycoin transaction") + "\n" +
              "\n";
