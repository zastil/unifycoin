...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.unifycoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("unifycointools.com", "dnsseed.unifycointools.com"));
        vSeeds.push_back(CDNSSeedData("unifycoinpool.org", "dnsseed.unifycoinpool.org"));
